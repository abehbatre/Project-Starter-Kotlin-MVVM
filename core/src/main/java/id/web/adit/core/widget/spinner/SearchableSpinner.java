package id.web.adit.core.widget.spinner;
...
public class SearchableSpinner extends Spinner implements View.OnTouchListener,
    ...
    public void dialogTitle(String s) {
        _searchableListDialog.setTitle(s);
    }


    public void dialogPositiveButtonText(String s) {
        _searchableListDialog.setPositiveButton(s);
    }
}
